...
var _IPhone = _interopRequireDefault(require("./components/IPhone8"));

var _IPhone2 = _interopRequireDefault(require("./components/IPhone10"));

var _Nexus = _interopRequireDefault(require("./components/Nexus5"));

var _Nexus2 = _interopRequireDefault(require("./components/Nexus9"));
...
function App() {
  var _useState = (0, _react.useState)('zznmxtj0k5z1czrwm129qgckmm'),
      _useState2 = _slicedToArray(_useState, 2),
      iosPublicKey = _useState2[0],
      setIosPublicKey = _useState2[1];

  var _useState3 = (0, _react.useState)('g0jthyryw2b433cyju3fwv8r5c'),
      _useState4 = _slicedToArray(_useState3, 2),
      androidPublicKey = _useState4[0],
      setAndroidPublicKey = _useState4[1];
  ...
  var _useState7 = (0, _react.useState)(false),
      ...
      isAutoplay = _useState8[0],
      setIsAutoplay = _useState8[1];
  ...
  var toggleAutoplay = function toggleAutoplay() {
    return setIsAutoplay(!isAutoplay);
  };
  ...
  return _react.default.createElement("div", null, _react.default.createElement("form", {
  ...
  }, "IOS Public Key", _react.default.createElement("input", {
    name: "iosPublicKey",
    type: "text",
    value: iosPublicKey,
    onChange: function onChange(evt) {
      return setIosPublicKey(evt.target.value);
    },
    placeholder: "Enter IOS public key"
  })), _react.default.createElement("label", {
    className: "form-field"
  }, "Android Public Key:", _react.default.createElement("input", {
    name: "androidPublicKey",
    type: "text",
    value: androidPublicKey,
    onChange: function onChange(evt) {
      return setAndroidPublicKey(evt.target.value);
    },
    placeholder: "Enter Android public key"
  })), _react.default.createElement("label", {
    className: "form-field"
  }, "Autoplay (careful about the minutes!)", _react.default.createElement("input", {
    type: "checkbox",
    checked: isAutoplay,
    ...
    className: "phones"
  }, _react.default.createElement(_IPhone.default, {
    autoplay: isAutoplay,
    publicKey: iosPublicKey
  }), _react.default.createElement(_IPhone2.default, {
    autoplay: isAutoplay,
    publicKey: iosPublicKey
  }), _react.default.createElement(_Nexus.default, {
    publicKey: androidPublicKey,
    autoplay: isAutoplay
  })), _react.default.createElement("div", {
    className: "tablets"
  }, _react.default.createElement(_Nexus2.default, {
    autoplay: isAutoplay,
    publicKey: androidPublicKey
  }))));
}
...
var _default = App;
exports.default = _default;
},{"react":"node_modules/react/index.js","./components/IPhone8":"src/components/IPhone8.js","./components/IPhone10":"src/components/IPhone10.js","./components/Nexus5":"src/components/Nexus5.js","./components/Nexus9":"src/components/Nexus9.js"}],"node_modules/scheduler/cjs/scheduler.development.js":[function(require,module,exports) {
...
"::";
},{"react":"node_modules/react/index.js","./App":"src/App.js","react-dom":"node_modules/react-dom/index.js","./styles.scss":"src/styles.scss"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
